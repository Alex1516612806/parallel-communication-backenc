...
// CLOUDINARY_URL=cloudinary://728617138534354:IXvYQU-aaG4gzjZaYrj0iqN5VWs@hyii3sgo2

// cloudinary.config({
//   cloud_name: 'sample',
//   api_key: '728617138534354',
//   api_secret: 'a676b67565c6767a6767d6767f676fe1',
// })

process.env.CLOUDINARY_URL =
  'cloudinary://728617138534354:IXvYQU-aaG4gzjZaYrj0iqN5VWs@hyii3sgo2'
...
const doUpload = (publicId, req, res, next) => {
  ...
  if (typeof req.file !== 'undefined') {
    ...
    console.log(req)
    // console.log('Try to debug the file buffer')
    s.end(req.file.buffer)
    s.pipe(uploadStream)
    s.on('end', uploadStream.end)
    // console.log('Done with pircture upload')
